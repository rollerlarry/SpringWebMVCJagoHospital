					...
					<div id="home-slider1" class="rev_slider" data-version="5.3">
						<ul>
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								<img src="resources/member/assets/images/slider.jpg" alt="slider" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							...
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								<img src="resources/member/assets/images/slide2.jpg" alt="slider" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							...
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								<img src="resources/member/assets/images/slide3.jpg" alt="slider" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-6">
							<div class="offer-box">
								...
								<p>Bạn có thể tìm ra bệnh sớm dựa vào các triệu chứng biểu hiện trên cơ thể bạn.</p>
								<a href="Diagnostic" title="Chuẩn Đoán Ngay">Chuẩn Đoán Ngay !</a>
							</div>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-6">
							<div class="offer-box">
						...
						<div class="col-md-4 col-sm-6 col-xs-6">
							<div class="offer-box">
								...
								<h5>Hỏi Bác Sỹ Trực Tuyến</h5>
								<p>Trò chuyện cùng với các sỹ có kinh nghiệm và nhận những lời khuyên tốt cho sức khỏe.</p>
								<a href="TalkWithDoctor" title="Trò Chuyện Ngay !">Trò Chuyện Ngay ! </a>
							</div>
						</div>
			...
			<div class="department-section container-fluid no-left-padding no-right-padding">
				...
				<div class="container">
					<div class="department-header">
						<h5>Danh sách các nhóm bệnh</h5>
					</div>
					<div class="row">
						<%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %>
						<c:forEach var = "diseasesGroup" items="${listDiseasesGroup}">
							<div class="col-md-2 col-sm-6 col-xs-6 department-box">	
								<a href="ListDiseasesGroup/${diseasesGroup.getIdDiseasesGroup()}">					
									<div class="department-img-block">
										<img src="${diseasesGroup.getDiseasesGroupImage()}" alt="dept">
										<span>${diseasesGroup.getDiseasesGroupName()}</span>
									</div>	
								</a>		
							</div>
						</c:forEach>   		
					...
					<div class="show-all">
						<a href="#" >Click vào để xem danh sách từng nhóm bệnh</a>
					</div>
				</div><!-- Container /- -->
				...
				<div class="container">
					<div class="col-md-7 col-sm-12 col-xs-12">
						<div class="service-content">
							<h5>DỊCH VỤ CHĂM SÓC SỨC KHỎE TRỰC TUYẾN.</h5>
							<p>Bạn có thể sử dụng dịch vụ của chúng tôi tại bất kỳ nơi nào bạn muốn.</p>
							<div class="medical-services">
								<div class="col-md-4 col-sm-4 col-xs-4 medical-box">
									<i class="fa fa-calendar-plus-o"></i>
									<p>Lịch trình chăm sóc sức khỏe rõ ràng</p>
								</div>
								<div class="col-md-4 col-sm-4 col-xs-4 medical-box">
									<i class="fa fa-ambulance"></i>
									<p>Tư vấn sức khỏe cơ động</p>
								</div>
								<div class="col-md-4 col-sm-4 col-xs-4 medical-box">
									<i class="fa fa-thumbs-up"></i>
									<p>Hỗ trợ nhiệt tình và nó miễn phí cho bạn</p>
								</div>
							</div>
							<a href="#" class="learn-more" title="Learn More">Xem thêm thông tin về chúng tôi</a>
							<span>HOẶC</span>
							<a href="#" class="learn-more appointment" title="Make an Appointment">Ủng hộ chúng tôi</a>
						</div>
					</div>
					<div class="col-md-5 col-sm-12 col-xs-12 services-img">
						<img src="resources/member/assets/images/services.jpg" alt="services" />
					</div>
				</div><!-- Container /- -->
